...
\textcolor{keywordtype}{void} myfunction(
  ...
  printf(\textcolor{stringliteral}{"Currently sitting on the node %i.\(\backslash\)nCurrent parents are: "}, iter->id());
...
List fancytree(\textcolor{keyword}{const} pruner::v\_uint & parents, \textcolor{keyword}{const} pruner::v\_uint & offspring) \{
  ...
  mytree.args = std::make\_shared< pruner::FunArgs >(1);
  mytree.fun = myfunction;
  
  \textcolor{comment}{// Calling functions}
  mytree.args->set\_nnodes(5);
